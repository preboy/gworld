...
func (m *PlayerDataResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Level != 0 {
		dAtA[i] = 0x30
		i++
		i = encodeVarint2Player(dAtA, i, uint64(m.Level))
	}
	if m.VipLevel != 0 {
		dAtA[i] = 0x38
		i++
		i = encodeVarint2Player(dAtA, i, uint64(m.VipLevel))
	}
	if m.Male {
		dAtA[i] = 0x40
		i++
...
func (m *PlayerDataResponse) Size() (n int) {
	...
	if m.Level != 0 {
		n += 1 + sov2Player(uint64(m.Level))
	}
	if m.VipLevel != 0 {
		n += 1 + sov2Player(uint64(m.VipLevel))
	}
	if m.Male {
		n += 2
	}
...
var fileDescriptor2Player = []byte{
	...
	,
}
