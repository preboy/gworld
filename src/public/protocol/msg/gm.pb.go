...
func (*GMCommandRequest) Descriptor() ([]byte, []int) { return fileDescriptorGm, []int{0} }
...
func (*GMCommandResponse) Descriptor() ([]byte, []int) { return fileDescriptorGm, []int{1} }
...
func (m *GMCommandRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Command) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintGm(dAtA, i, uint64(len(m.Command)))
...
func (m *GMCommandResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Result != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintGm(dAtA, i, uint64(m.Result))
	}
	return i, nil
}
...
var fileDescriptorGm = []byte{
	...
	0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0xce, 0x2d, 0x4e, 0x57, 0xd2, 0xe1, 0x12, 0x70, 0xf7, 0x75,
	0xce, 0xcf, 0xcd, 0x4d, 0xcc, 0x4b, 0x09, 0x4a, 0x2d, 0x2c, 0x4d, 0x2d, 0x2e, 0x11, 0x92, 0xe0,
	0x62, 0x4f, 0x86, 0x88, 0x48, 0x30, 0x2a, 0x30, 0x6a, 0x70, 0x06, 0xc1, 0xb8, 0x4a, 0xda, 0x5c,
	0x82, 0x48, 0xaa, 0x8b, 0x0b, 0xf2, 0xf3, 0x8a, 0x53, 0x85, 0xc4, 0xb8, 0xd8, 0x8a, 0x52, 0x8b,
	0x4b, 0x73, 0x4a, 0xc0, 0xaa, 0x59, 0x83, 0xa0, 0x3c, 0x27, 0x81, 0x13, 0x8f, 0xe4, 0x18, 0x2f,
	0x3c, 0x92, 0x63, 0x7c, 0xf0, 0x48, 0x8e, 0x71, 0xc2, 0x63, 0x39, 0x86, 0x24, 0x36, 0xb0, 0xc5,
	0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0x6f, 0xe0, 0x95, 0xf8, 0x84, 0x00, 0x00, 0x00,
}
